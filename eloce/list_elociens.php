...
<head>
    ...
    <link rel="stylesheet" href="elociens.css">
    ...
    <script src="list_elociens.js"></script>
    <title>Elocien_liste</title>
</head>
<body>
    ...
    <div class="container">
        <div id="team" class="section">
            <h5 class="section-title h1">ELOCIENS</h5>

            <div id="select_formations" class="row">
